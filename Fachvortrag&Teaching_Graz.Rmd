...
* Digital traces of collective emotions
* Validity of social media emotion & sentiment measures <br> <br>
* Using Machine learning to study effects of social media content on mental health <br> <br>
* Behavior in social media environments: <br>
Spreading of false and accurate information 
]


???
Make boxes around each of these
...
put last 2 points together as information spreading: protection + information spreading
pictures larger
make slide about EA for questions
...
what are we measuring: daily tweets, suicides, and calls to the helpline
we are measuring time series of tweets - in picture
...
* Model spreading & interventions in social networking platforms
]
 </top>
...
I have been working with CS students, they need to be goal oriented, experience in mentoring at the Data Science master
In psych, important to translate to practice
...
### Teaching Lecture on *Digital Technologies and Psychology* <br> Hannah Metzler


??? 
Make start very clear: Dear Students...
Make clear I know about who students are
...
* Polarization
* Hate speech
* Reducing racial harrassement
]]
--
**=>Machine Learning & <br> example application**
...
* BERT: Masked word prediction <span style="font-size: 22px; font-color: gray"> <br> Devlin et al. (2019) </span> 
    * 12 layers
    * “New **[MASK]** is a city” 
...
???
Potato example
One hot encoding: input layer has as many words as there are in the sentence, mention that output layer is probabilities
Input: one-hot times embedding, everything but the mask

output has as many units as words in the dictionary, one has a maximum value which is the one we predict
...
.left-column[
```{r, echo=FALSE, out.width=300}
knitr::include_graphics("figures/metrics.svg")
```
]
.right-column[.center-right[
...
* **Recall**: 
    ...
    * How many of the actually angry tweets does it get?
...
???
Explain the plot
Add equation for precision and recall
harmonic mean
...
layout:true
<div class="my-footer"><span>
<a href="https://www.pnas.org/content/115/37/9216">Exposure to opposing views on social media can increase political polarization. Bail et al. (2018) PNAS </a></span></div>


---

# Machine Learning for Suicide Prevention

Critical thinking: accuracy majority class would just predict irrelevant, this is why we need precision and recall

???

# A field experiment on political polarization

.pull-left[.center-left[
* Group differences more extreme & aligend with group identity
<br> <br>
* Echo chambers on social media ?
<br><br>
* Innovative methods: Surveys, bot technology & digital trace data <br><br>
  * Virtual inter-group contact
  * Motivated reasoning, backfiring? 
<br><br>
* Frequent Twitter users from the US
]]
...
Treatment: follow bot for 1 month, retweets 24 messages/day of opposing political ideology (politicians, opinion leaders, media, ngos)

Motivated reasoning: strengthen inital belief if exposed to statements that defend the opposite

Survey:  change in political ideology, statements about policy issues, Twitter ID
Weekly: compliance test, questions about retweeted content
---

# Increased polarization: Backfire effect

* Repeated contact between groups on social media over extended period

```{r, echo=FALSE, out.width=900}
knitr::include_graphics("figures/bail_results.svg")
```
* Stronger backfire effect in conservatives: certainy & tradition
* Exposure to opposing views may be counter-productive
...
* CSS as highly interdisciplinary field

* Digital technologies: New opportunities for psychological research

* Basics in Machine Learning for text analysis

* New important insights through combining <br> **digital trace data** + psychological **experiments**
...
Questions: 
sentences about difference to David
syntergy in methods, but focus really different. Not a psychologist. 
Comp