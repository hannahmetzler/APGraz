...
* Validity of emotion & sentiment measures <br> <br>
...
* **Teaching concept**
  ...
  * Introduction to Psychology I & II (Lecture + exercies) <br> <br>
...
* Social contagion effect for suicidal behavior
* Messages about suicide are associated with case numbers & helpline calls
* Text characteristics matter
...
--
.pull-right[
* Deep Learning models similar and better than TF-IDF.

* Valuable information in context beyond word frequencies
]

---

# Results: Performance per class/about suicide

About suicide vs. not
accuracy majority class would just predict irrelevant, this is why we need precision and recall

* Machine Learning is a useful & effective tool for media effects research
* Allows large-scale analysis
